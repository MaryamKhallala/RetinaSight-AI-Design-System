...
|---|---|
| `_research/PRD.txt` (extracted from `Octopus_AI_PRD_v1.0.docx`) | Product scope, personas, requirements, tech stack, glossary |
| `_research/thesis_proposal.pdf` & `thesis_proposal_Prez.pdf` | Background on the underlying PhD research informing the platform |
...
apps/web/
  ...
  admin/                   ← Administration (users · datasets · model registry)
    {index.html, app.jsx, app.css, README.md}
_research/                 ← extracted PRD text + source PDFs (reference only)
```
